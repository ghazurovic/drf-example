...
class StandardResultsSetPagination(pagination.PageNumberPagination):
    ...
    def get_paginated_response(self, data: QuerySet) -> typing.Optional[Response]:
        ...
        self.actual_page_size = int(_page_size_param) if int(_page_size_param) != self.page_size else self.page_size
        return Response({
            'links': {
    ...
    def calc_from_page(self):
        _from_page = self.actual_page_size * self.page.number - (self.actual_page_size - 1)
